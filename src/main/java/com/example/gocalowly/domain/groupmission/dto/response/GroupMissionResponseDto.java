...
public class GroupMissionResponseDto {
    private final List<Mission> missions; // 미션 리스트를 전달합니다.
    ...
    public static class Mission { // 미션 클래스를 내부에서 선언합니다.
        private final int missionNo; // 미션 ID
        private final String missionName; // 미션 이름
        private final boolean isMissionComplete; // 미션 달성 여부
